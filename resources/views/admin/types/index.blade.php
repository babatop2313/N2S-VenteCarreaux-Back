                        ...
                        <tbody>
                            @if($types->isNotEmpty())
                                ...
                                <td>
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <a href="#" onclick="deleteType({{$type->id}})" class="text-danger w-4 h-4 mr-1">
                                    ...
                                    {{-- <td>
                                        <form action="{{ route('types.destroy',$type->id) }}" method="POST">
                                            ...
                                            <a class="btn btn-primary" href="{{ route('types.edit',$type->id) }}">Modifier</a>
                                            @csrf
                                            @method('DELETE')
                            ...
                            @else
                            <tr>
                                <td colspan="5" class="text-center">Aucun enregitrement</td>
                            </tr>
                            @endif
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response["status"] == true){
                    location.reload(); // Rechargez la page actuelle
                }
            }
        });
    }
